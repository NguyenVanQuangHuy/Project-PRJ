            ...
            <div class="col-md-2">
             <c:if test="${acc!=null}">
                <c:if test="${acc.getRole_id()==0}">
                             <a href="inforcontrol"><i class="bi bi-person-circle"></i>
          </a>
          ...
          <ul class="list-group list-group-numbered">
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="">
                  <a href="inforcontrol?iforid=${sessionScope.acc.getAccount_id()}">Cai Dat Tai Khoan</a>
                </div>
              </div>
            </li>
             <li class="list-group-item d-flex justify-content-between align-items-start">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="">
                  <a href="historyoder?accid=${sessionScope.acc.getAccount_id()}">Lich Su Dat Ve</a>
                </div>
              </div>
                     ...
                     <div class="row">
                        ...
                        <div class="card" style="width: 18rem;">                         
                          ...
                          <div class="card-body">
                            ...
                            <c:if test="${acc.getRole_id()==1}">
                            <a href="addtocartcontrol?aid=${i.product_id}" class="btn btn-primary button_tour"> <i class="bi bi-cart-plus-fill"></i></a>
                            </c:if>
                          </div>
                        </div>
                            <c:if test="messcart!=null">
                              <h6> ${messcart}</h6>  
                            </c:if>
                            
                      </div>
                          </c:forEach>
                          <c:forEach var="page" begin="1" end="${config.totalPage}">
                          <span class =" btnPage"><a herf="cotrollerHome?pageIndex=${config.page_index}">${page}</a></span>
                          </c:forEach>
                     </div>
                  </div>
                </div>
