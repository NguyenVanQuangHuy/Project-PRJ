...
public class searchControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(search != null){
            ...
            cate = de.getList_cate();
            for (Product pro : prod) {
                if(search.equals(pro.getProductname())){
                    Product pro2 = pro;
                    prod2.add(pro);
                }    
            }
            request.setAttribute("product", prod2);  
            request.setAttribute("category", cate);
        }
        
        request.getRequestDispatcher("Views/homesearch.jsp").forward(request, response);
    } 
